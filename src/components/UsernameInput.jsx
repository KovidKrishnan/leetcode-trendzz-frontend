...
export default function UsernameInput() {
  ...
  useEffect(() => {
    fetch("https://leetcode-trendzz.onrender.com/connect", {
      method: "GET",
      headers: {
    ...
    <div>
          ...
          <Card className="bg-transparent">
            ...
            <Card.Body>
              ...
              <Button
                ...
                style={{ backgroundColor: "#ff861c" }}
              >
                <Link to={`/dashboard?username=${name}`} className="text-dark">
                  Drive Leetcode
                </Link>
              </Button>
            </Card.Body>
      ...
      <div className="d-flex justify-content-center align-items-center mt-2">
        <p>
          Made with &#10084; by{" "}
          <a
            href="https://linkedin.com/in/kovidkrishnan"
